...
import static ru.zhidev.lunch_voting_system.user.UserTestData.*;
import static ru.zhidev.lunch_voting_system.user.web.AdminUserController.REST_URL;
import static ru.zhidev.lunch_voting_system.user.web.UniqueMailValidator.EXCEPTION_DUPLICATE_EMAIL;
