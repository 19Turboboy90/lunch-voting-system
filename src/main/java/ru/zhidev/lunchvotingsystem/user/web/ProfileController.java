...
import ru.zhidev.lunchvotingsystem.user.to.UserTo;
import ru.zhidev.lunchvotingsystem.user.util.UsersUtil;

import java.net.URI;

import static ru.zhidev.lunchvotingsystem.common.validation.ValidationUtil.assureIdConsistent;
import static ru.zhidev.lunchvotingsystem.common.validation.ValidationUtil.checkIsNew;
