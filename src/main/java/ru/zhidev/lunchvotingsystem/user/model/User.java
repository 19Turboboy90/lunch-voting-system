package ru.zhidev.lunchvotingsystem.user.model;
...
import ru.zhidev.lunchvotingsystem.common.HasIdAndEmail;
import ru.zhidev.lunchvotingsystem.common.model.NamedEntity;
import ru.zhidev.lunchvotingsystem.common.validation.NoHtml;
...
@Table(name = "users",
        schema = "public",
        uniqueConstraints = {@UniqueConstraint(name = "users_unique_email_idx", columnNames = {"email"})})
@Getter
@Setter
